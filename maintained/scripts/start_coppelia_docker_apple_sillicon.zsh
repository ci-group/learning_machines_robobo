...
docker build --platform linux/amd64 --tag coppelia_sim .

unlink ./tmp_dockerfiles/to_open.ttt
rmdir ./tmp_dockerfiles

docker run -it --rm --platform linux/amd64 -p "${2:-23000}:${2:-23000}" coppelia_sim -h "-GzmqRemoteApi.rpcPort=${2:-23000}"
